...
export const metadata: Metadata = {
  title: 'Rich Cars 3 – Unblocked Luxury Car Game',
  description: 'Play Rich Cars 3 unblocked for free. Race luxury cars and evade the police.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Live the fast life in Rich Cars 3. Race expensive cars, perform stunts, and escape the police in this unblocked action game.
          </p>
