...
export const metadata: Metadata = {
  title: 'Ben 10 Racing – Unblocked Cartoon Racing Game',
  description: 'Play Ben 10 Racing unblocked for free. Race as your favorite Ben 10 aliens.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Race against other aliens as your favorite Ben 10 characters. A fun and easy-to-play unblocked racing game for all ages.
          </p>
