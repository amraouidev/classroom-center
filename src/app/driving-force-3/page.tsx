...
export const metadata: Metadata = {
  title: 'Driving Force 3 – Unblocked Police Game',
  description: 'Play Driving Force 3 unblocked for free. Join the police force and take down criminals.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Join the police force and complete missions in Driving Force 3. An action-packed unblocked driving game.
          </p>
