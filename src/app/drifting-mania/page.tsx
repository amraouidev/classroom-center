...
export const metadata: Metadata = {
  title: 'Drifting Mania – Unblocked Drifting Game',
  description: 'Play Drifting Mania unblocked for free. Become a drift king in this exciting game.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Experience the thrill of drifting in Drifting Mania. Show off your skills and become the king of the drift. Play unblocked now.
          </p>
