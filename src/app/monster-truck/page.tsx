...
export const metadata: Metadata = {
  title: 'Monster Truck – Unblocked Crushing Game',
  description: 'Play Monster Truck unblocked for free. Drive a monster truck and crush everything in your path.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Unleash the power of a monster truck! Crush cars, overcome obstacles, and cause mayhem in this fun unblocked game.
          </p>
