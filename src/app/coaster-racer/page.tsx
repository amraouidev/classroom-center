...
export const metadata: Metadata = {
  title: 'Coaster Racer – Unblocked Racing Game',
  description: 'Play Coaster Racer unblocked for free. Race on thrilling roller coaster tracks.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Get ready for a unique racing experience. Race on wild roller coaster tracks and perform stunts in Coaster Racer. Play unblocked at school.
          </p>
