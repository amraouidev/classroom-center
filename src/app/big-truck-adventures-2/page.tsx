...
export const metadata: Metadata = {
  title: 'Big Truck Adventures 2 – Unblocked Truck Game',
  description: 'Play Big Truck Adventures 2 unblocked for free. More adventures and challenges with your big truck.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            The adventure continues! Drive your big truck through new levels and overcome obstacles in Big Truck Adventures 2.
          </p>
