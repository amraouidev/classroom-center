...
export const metadata: Metadata = {
  title: 'Mountain Bike – Unblocked Biking Game',
  description: 'Play Mountain Bike unblocked for free. Ride your bike through challenging mountain trails.',
};
    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-lg leading-8 text-muted-foreground space-y-6">
          <p>
            Get ready for an off-road adventure. Ride your mountain bike through tough trails and reach the finish line. Play unblocked now.
          </p>
